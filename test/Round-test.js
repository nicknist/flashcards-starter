...
describe('Round', function() {
  ...
  describe('returnCurrentCard Method', function() {
    ...
    it('endRound method should print the specific message', function () {
      round.takeTurn('sea otter');
      expect(round.endRound()).to.equal(console.log(`**Round Over!** You
        answered 100% of the questions correctly in 0 minutes and 0 seconds!`));
    });
    ...
    it(`endRound method should display the correct percentage of correct
      ...
      round.takeTurn('sea otter');
      expect(round.endRound()).to.equal(console.log(`**Round Over!** You
        answered 100% of the questions correctly!`));
      round.takeTurn('spleen');
      expect(round.endRound()).to.equal(console.log(`**Round Over!** You
        answered 50% of the questions correctly!`));
      round.takeTurn('watching Netflix');
      expect(round.endRound()).to.equal(console.log(`**Round Over!** You
        answered 33% of the questions correctly!`));
    });
  });
});

...
describe ('Turn', function() {
  ...
  it('evaluateGuess should return boolean based on user guess and correctAnswer matching', function() {
    const card = new Card(1, 'What allows you to define a set of related information using key-value pairs?', ['object', 'array', 'function'], 'object');
  ...
  it('giveFeedback method should return a correct or incorrect based on correctAnswer and guess matching', function() {
    const card = new Card(1, 'What allows you to define a set of related information using key-value pairs?', ['object', 'array', 'function'], 'object');
    const turnWrong = new Turn('pug', card);
    const turnCorrect = new Turn('object', card);
